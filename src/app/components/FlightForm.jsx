...
const Flightform = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3001/api/flight', formData);
                ...
                <div className="row">
                    <div className="form-groups col-md-6">
                        <input
                            ...
                            className="form-control"
                            name="pickup_airpot"
                            placeholder="Enter your pickup airpot"
                            value={formData.pickup_airpot}
                            onChange={handleChange}
                        />
                    </div>
                    <div className="form-groups col-md-6">
                        <input
                            ...
                            className="form-control"
                            name="drop_airpot"
                            placeholder="Enter your drop airpot"
                            value={formData.drop_airpot}
                            onChange={handleChange}
                        />
                    </div>
                </div>
